...
const Signup = () => {
    ...
    return (
      <div>
        {/* Tab */}
        {/* Form */}
        <form onSubmit={handleOnSubmit} className="flex w-full border lg:border-none px-2 py-3 rounded-lg border-white flex-col gap-y-4">
          <div className="flex flex-col lg:flex-row lg:gap-x-4 gap-4">
            <label>
